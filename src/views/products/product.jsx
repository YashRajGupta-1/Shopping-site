            ...
            <div className="prod-info">
              ...
              <p>
                <span className="prod-rating">
                  {prod.rating.rate} <FaStar className="star" />
                </span>{" "}
              ...
              <ul className="specs-list">
                {Object.entries(prod.speci).map(([key, value], index) => (
                  <li key={index} className="specs-list1">
                    <p className="speci-key">{key}</p>:{" "}
                    <p className="speci-value">{value}</p>
                  </li>
                ))}
              </ul>
              <div className="action-buttons">
                {cart_btn ? (
                  <button
                    onClick={() => addtocart(prod.title, prod.price, 1)}
                ...
                <button
                  onClick={() => addtowishlist(prod.title)}
                  className={redornot ? "filledheart" : "add-to-wishlist"}
                >
                  {" "}
                  <span>
                    <FaHeart /> Wishlist{" "}
